...
#define ___UTILITY_SYSTEM_BITS  32
#define ___UTILITY_BITS         1
...
#define ___UTILITY_CHAR_BITS      
#define ___UTILITY_SHORT_BITS     
#define ___UTILITY_INT_BITS       
#define ___UTILITY_LONG_BITS      
#define ___UTILITY_LLONG_BITS     
#define ___UTILITY_FLOAT_BITS     
#define ___UTILITY_DOUBLE_BITS    
#define ___UTILITY_LDOUBLE_BITS   
#define ___UTILITY_PTR_BITS       
