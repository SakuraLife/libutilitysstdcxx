...
namespace utility
{
  namespace container
  {
    ...
    template<size_t _Idx, typename _T>
    using tuple_element_t = typename tuple_element<_Idx, _T>::type;
    ...
    class tuple
    {
      ...
      public:
        template<
          typename _CT = bool,
          typename construct_traits::template __default<_CT>::type = true,
        ...
        template<
          typename _CT = bool,
          typename construct_traits::template __copy<_CT, _Types...>::type = true,
          typename __detail::enable_if<
        ...
        // template<
        //   typename _CT = bool,
        //   typename construct_traits::template __left<_Types&&...>::type = true,
        //   typename __detail::enable_if<
        //     explict_construct_traits::template __left<_Types&&...>::value,
        //   _CT>::type = false
        // >
        // __UTILITY_CPP14_CONSTEXPR__
        // tuple(_Types&&... _args) noexcept(
        //   noexcept_construct_traits::template __left<_Types&&...>::value
        // ): __base{
        //   __detail::__type_tuple_get_array_type__<
        //     __detail::make_index_sequence<sizeof...(_Types)>,
        //     __detail::__type_tuple__<_Types...>
        //   >{},
        //   __detail::__type_tuple_get_array_type__<
        //     __detail::make_index_sequence<sizeof...(_Types), sizeof...(_Types)>,
        //     __detail::__type_tuple__<_Types...>
        //   >{},
        //   __detail::make_index_sequence<sizeof...(_Types)>{},
        //   __detail::make_index_sequence<sizeof...(_Types), sizeof...(_Types)>{},
        //   algorithm::forward<_Types>(_args)...
        // }
        // { }
        // template<
        //   typename _CT = bool,
        ...
        // >
        // __UTILITY_CPP14_CONSTEXPR__
        // explicit tuple(_Types&&... _args) noexcept(
        //   noexcept_construct_traits::template __left<_Types&&...>::value
        // ): __base{
        //   __detail::__type_tuple_get_array_type__<
        //     __detail::make_index_sequence<sizeof...(_Types)>,
    ...
    __UTILITY_CPP14_CONSTEXPR__
    inline tuple<> tuple_cat() noexcept
    { return tuple<>{};}
    ...
    template<size_t... _IS, typename _F, typename _Tuple>
    __UTILITY_CPP14_CONSTEXPR__
    auto apply(_F&& _func, _Tuple&& _tuple) -> decltype(
      functional::invoke(
        algorithm::forward<_F>(_func),
        get<_IS>(algorithm::forward<_Tuple>(_tuple))...
      )
    )
    {
      using algorithm::forward;
      using functional::invoke;
      return invoke(forward<_F>(_func), get<_IS>(forward<_Tuple>(_tuple))...);
    }

    namespace __detail
    {
      template<typename _F, typename _Tuple, size_t... _IS>
      __UTILITY_CPP14_CONSTEXPR__
      auto __apply(_F&& _func, _Tuple&& _tuple, index_sequence<_IS...>) -> decltype(
        functional::invoke(
          algorithm::forward<_F>(_func),
          get<_IS>(algorithm::forward<_Tuple>(_tuple))...
        )
    ...
    auto apply(_F&& _func, _Tuple&& _tuple) -> decltype(
      __detail::__apply(
        algorithm::forward<_F>(_func),
        algorithm::forward<_Tuple>(_tuple),
        trait::make_index_sequence<tuple_size<_Tuple>::value>{}
      )
    )
    {
      using algorithm::forward;
      ...
      return __detail::__apply(
        forward<_F>(_func),
        forward<_Tuple>(_tuple),
        make_index_sequence<tuple_size<_Tuple>::value>{}
      );
    }
