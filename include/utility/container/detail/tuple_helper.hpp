...
__utility_globalspace_start(utility)
  __utility_interspace_start(container)
    namespace __detail
    {
      ...
      using trait::__opt__::__type_tuple_get_array_type__;
      ...
      struct __construct
      {
        ...
        template<typename _Target, typename... _UType>
      ...
      struct __miscellaneous
      {
        ...
        using __possible_swap_noexcept = __and__<
